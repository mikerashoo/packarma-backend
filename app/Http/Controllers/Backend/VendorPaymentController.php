...
class VendorPaymentController extends Controller
{
    ...
    */
    ...
    {   
        ...
        // return view('backend/vendors/vendor_payment_list/index',['data' =>$data] ); 
        try {
    ...
    public function fetch(Request $request){
        if ($request->ajax()) {
        	try {
                ...
                ->addIndexColumn()                
                ->rawColumns(['vendor_name','order_id','payment_mode','payment_status','updated_at','action'])->setRowId('id')->make(true);
	        }
	        catch (\Exception $e) {
