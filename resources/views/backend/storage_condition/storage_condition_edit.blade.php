                    		...
                    		<form id="editStorageCondition" method="post" action="saveStorageCondition?id={{$data->id}}">
                        		...
                        		<div class="row">
                                    ...
                                    <div class="col-sm-6">
                        				...
                        				<input class="form-control required" type="text" id="storage_condition_description" name="storage_condition_description" value="{{ $data->storage_condition_description }}"><br/>
                        			</div>
                        		</div>
                        		<hr>
                        		<div class="row">
