                    		...
                    		<form id="editSubCategoryForm" method="post" action="saveSubCategory?id={{$data->id}}">
                        		...
                        		<div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control required" type="file" id="sub_category_image" name="sub_category_image" accept="sub_category_image/png, sub_category_image/jpg, sub_category_image/jpeg" onchange="checkFiles(this.files)"><br/>
