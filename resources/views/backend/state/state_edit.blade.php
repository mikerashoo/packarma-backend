                    		...
                    		<form id="editStateForm" method="post" action="saveState?id={{$data->id}}">
                        		...
                        		<div class="row">
                        			<div class="col-sm-6">
                        				...
                        				<input class="form-control" type="text" id="state_name" name="state_name" value="{{$data->state_name}}"><br/>
                        			</div>
                                    <div class="col-sm-6">
                                        <label>Country Name</label>
                                        <select class="select2" id="country" name="country" style="width: 100% !important;">
