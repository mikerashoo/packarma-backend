                                    ...
                                    <div class="tab-pane fade mt-2 show active" id="details" role="tabpanel" aria-labelledby="details-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="file" id="banner_image" name="banner_image" class="form-control required" accept="banner_image/png, banner_image/jpg, banner_image/jpeg" onchange="checkFiles(this.files)"><br/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="pull-right">
                                                <button type="button" class="btn btn-success" onclick="submitForm('addBannersForm','post')">Submit</button>
                                                <a href="{{URL::previous()}}" class="btn btn-sm btn-primary px-3 py-1"><i class="fa fa-arrow-left"></i> Back</a>
                                            </div>
                                        </div>
                                    </div>
