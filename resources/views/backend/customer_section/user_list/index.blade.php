                                ...
                                <div class="card-content">
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                                ...
                                                @if ($data['add_user'])
                                                    <a href="add_user" class="btn btn-sm btn-outline-primary px-3 py-1 src_data"><i class="fa fa-plus"></i> Add User</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped datatable" id="dataTable" width="100%" cellspacing="0" data-url="user_list_data">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        @if($data['user_list_status'] || $data['user_list_edit'])
